...
def build() -> dict:
    ...
    # Note: Tavily quota consumption is fetched live from /api/data in
    # api-server.py against Tavily's /usage endpoint — local trajectory
    # counting missed gateway-internal calls (plugin hook, skill, retries).
